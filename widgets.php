...
if( ! class_exists( 'CS_Widget_skin' ) ) {
  class CS_Widget_skin extends WP_Widget {
    ...
    function widget( $args, $instance ) {
      ...
      echo '<li class="skin1"><a class="simptip-position-bottom simptip-smooth simptip-movable" data-tooltip="复古" href="';
      ?><?php echo get_template_directory_uri(); ?><?php 
      echo '/skin/switcher.php?style=skin01.css">1</a></li>';
      echo '<li class="skin2"><a class="simptip-position-bottom simptip-smooth simptip-movable" data-tooltip="清新" href="';
      ?><?php echo get_template_directory_uri(); ?><?php
